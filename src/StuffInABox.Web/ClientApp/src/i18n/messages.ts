...
const sv = {
  ...
  'subscription.limitSpaces': '{n} utrymmen',
  'subscription.limitItems': '{n} föremål',
  'subscription.limitMembers': '{n} medlemmar/utrymme',
  'subscription.limitAi': '{n} AI-foton/mån',
  'subscription.limitStorage': '{size} lagring',
...
const en: Record<MessageKey, string> = {
  ...
  'subscription.limitSpaces': '{n} spaces',
  'subscription.limitItems': '{n} items',
  'subscription.limitMembers': '{n} members/space',
  'subscription.limitAi': '{n} AI photos/mo',
  'subscription.limitStorage': '{size} storage',
