...
const sv = {
  ...
  'subscription.free0': 'Gratis',
  'subscription.perMonth': '{price} kr/mån',
  'subscription.usage': 'Förbrukning',
  'subscription.spaces': 'Utrymmen',
  'subscription.items': 'Föremål',
  'subscription.aiPhotos': 'AI-foton (mån)',
  'subscription.storage': 'Lagring',
  'subscription.unlimited': 'Obegränsat',
  'subscription.comparePlans': 'Jämför nivåer',
  'subscription.currentBadge': 'Nuvarande',
  'subscription.upgrade': 'Uppgradera',
  'subscription.upgradeNote': 'Uppgradering sker manuellt under introduktionen – hör av dig så byter vi din plan.',
  'subscription.limitSpaces': 'Utrymmen: {n}',
  'subscription.limitItems': 'Föremål: {n}',
  'subscription.limitMembers': 'Medlemmar: {n}',
  'subscription.limitAi': 'AI-foton/mån: {n}',
  'subscription.limitStorage': 'Lagring: {size}',
  'subscription.featClaude': 'AI-berikning (Claude)',
  'subscription.featPriority': 'Prioriterad AI-kö',
  'subscription.featThemes': 'Alla teman',
  'plan.free.label': 'Låda',
...
const en: Record<MessageKey, string> = {
  ...
  'subscription.free0': 'Free',
  'subscription.perMonth': '{price} SEK/mo',
  'subscription.usage': 'Usage',
  'subscription.spaces': 'Spaces',
  'subscription.items': 'Items',
  'subscription.aiPhotos': 'AI photos (mo)',
  'subscription.storage': 'Storage',
  'subscription.unlimited': 'Unlimited',
  'subscription.comparePlans': 'Compare tiers',
  'subscription.currentBadge': 'Current',
  'subscription.upgrade': 'Upgrade',
  'subscription.upgradeNote': "Upgrades are handled manually during early access — get in touch and we'll switch your plan.",
  'subscription.limitSpaces': 'Spaces: {n}',
  'subscription.limitItems': 'Items: {n}',
  'subscription.limitMembers': 'Members: {n}',
  'subscription.limitAi': 'AI photos/mo: {n}',
  'subscription.limitStorage': 'Storage: {size}',
  'subscription.featClaude': 'AI enrichment (Claude)',
  'subscription.featPriority': 'Priority AI queue',
  'subscription.featThemes': 'All themes',
  'plan.free.label': 'Box',
